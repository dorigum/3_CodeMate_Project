...
- [프로젝트 명세](PROJECT_SPECIFICATION.md)
- [시스템 아키텍처](ARCHITECTURE.md)
- [데이터베이스 설계](DATABASE_DESIGN.md)
- [트러블슈팅](TROUBLESHOOTING.md)
- [CodeMate 실행 가이드](CodeMate_실행_가이드.md)
- [프로젝트 회고](RETROSPECTIVE.md)

## 날짜별 개발 기록

- [2026-06-10](project-log/2026-06-10.md): 참여 신청 취소 및 스터디 탈퇴, 프로젝트 설계 문서 및 도메인 단위 테스트
